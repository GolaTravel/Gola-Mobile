...
import AdventureCardMore from "../../components/AdventureCardMore";
...
const featured = [
    {
        ...
        downloads: 'The Temple of the Sacred Tooth Relic, located in the city of Kandy,is a significant Buddhist temple.',
        stars: 4
    },
    {
        id: 2,
                ...
                <SafeAreaView className="flex-1">
                    ...
                    <View className="flex-row justify-between items-center px-1 py-3">
                        ...
                        <View className="flex-row items-center space-x-2">
                            <Text className="text-2xl font-semibold">Experiences</Text>
                        </View>
                            ...
                            <ScrollView  showsVerticalScrollIndicator={false}>
                                {
                                    ...
                                    featured.map((item, index)=>{
                                        return (
                                            <AdventureCardMore key={index} game={item} />
                                        )
                                    })
                                }
                                </ScrollView>
